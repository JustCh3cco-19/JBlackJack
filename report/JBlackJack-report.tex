...
diagram is maintained as a separate project artifact in the \code{UML/} directory and
is included automatically when this report is built.
...
profile storage. Generating the UML diagram directly from source during continuous
integration would also keep it synchronized automatically.
